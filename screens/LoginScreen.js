    ...
    <View className="flex-1 bg-[#3E0288]">
      ...
      <View
        ...
        style={{
          marginTop:
            statusBarHeight +
            (Platform.OS === 'ios' ? height * 0.08 : height * 0.04),
          height: height * 0.12,
        }}
      >
        <Text
      ...
      >
        ...
        <View className="flex-row" style={{ marginBottom: spacing * 3 }}>
          <TouchableOpacity
            ...
            style={{
              borderBottomColor:
                activeTab === 'Email' ? '#3E0288' : 'transparent',
          ...
          <TouchableOpacity
            ...
            style={{
              borderBottomColor:
                activeTab === 'Phone' ? '#3E0288' : 'transparent',
              paddingVertical: spacing,
            }}
            onPress={() => {
              setActiveTab('Phone');
        ...
        <View className="relative" style={{ marginBottom: spacing * 2.2 }}>
          ...
          <TouchableOpacity
            ...
            className="absolute right-[15px] top-5 bottom-0 justify-center items-center"
            style={{ width: 20 }}
          >
            <Ionicons
